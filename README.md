...
function MakeNotifi(Configs)
  ...
  local text = Configs.Text or "Notifica̤̣o"
...
function MakeWindow(Configs)
  ...
  local function CreateClose()
    ...
    local Mensage = Create("TextLabel", CloseMenu, {
      ...
      Text = "Voc̻ tem certeza que deseja fechar o SH HUB? ",
  ...
  function MakeTab(Configs)
    ...
    if TabTitle then
      Create("TextLabel",Container,{BackgroundTransparency=1,Text="#"..string.gsub(TabName," ","-"),TextSize=25,Font=Configs_HUB.Text_Font,TextXAlignment="Left",
